                ...
                <form action="/register/user/process" method="POST" enctype="multipart/form-data" id="form">
                    ...
                    <div class="grid grid-cols-1 gap-4 items-start mt-4 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div class="grid flex flex-col items-start space-y-0.5">
                            ...
                            <input class="shadow appearance-none border rounded h-fit w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="lastname" type="text" placeholder="Last Name" name="last_name" value="{{old('last_name')}}">
                        </div>
                    ...
                    <div class="fixed inset-0 flex items-center justify-center hidden" id="termsPopup">
                        ...
                        <div class="bg-white w-full md:max-w-2xl max-w-sm rounded shadow-lg p-8 relative z-10 overflow-y-auto max-h-[80vh]">
                            ...
                            <p id="termsContent" class="ml-4 text-justify">
                                ...
                                <span class="ml-8">1.1.1 Patients consent to the continuous monitoring of their vital signs through the Med-bot IoT system.</span><br>
