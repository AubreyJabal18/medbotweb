...
<body>
    ...
    <div class="flex flex-col w-screen h-screen bg-gradient-to-r from-[#5b86e5] to-[#305ab9] items-center p-4 md:flex-row md:items-center md:justify-center md:space-x-4 lg:px-12">
        ...
        <img src="{{asset('images/side view 2.png')}}" alt=" " class="block md:hidden absolute h-[20%] w-[38%] self-start top-[50%] -left-5">

        <img src="{{asset('images/side view.png')}}" alt=" " class="hidden absolute md:block md:right-2 md:bottom-20 lg:bottom-12 md:right-0 lg:right-10 md:w-[22%] md:h-[25%] lg:w-[18%] lg:h-[30%] self-end">
