...
<body>
    ...
    <div class="flex h-screen bg-gradient-to-r from-[#5b86e5] to-[#305ab9] flex-col items-center px-4">
        <p class="flex flex-col text-2xl md:text-4xl font-semibold md:font-bold justify-self-center font-roboto text-[#5ececd] mt-3 md:mt-5 text-shadow text-center">ENHANCED MED-BOT</p>
        ...
        <div class="relative flex flex-col w-4/5 md:w-2/5 h-96 md:h-4/5 bg-white items-center rounded-2xl md:rounded-2xl lg:w-[35%]">
            ...
            <p class="flex flex-row text-[#919191] font-bold font-roboto text-[10px] md:text-[13px] justify-self-center mt-8 md:mt-24 mb-2 md:mb-1">Don't have an account? &nbsp;<u href="#"  class="flex flex-row font-roboto text-blue-500 hover:text-blue-700 text-[10px] md:text-[13px] justify-self-center">Register here</u></p>
